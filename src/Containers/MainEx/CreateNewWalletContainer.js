...
const CreateNewWalletContainer = ({ }) => {
    ...
    return (<SafeAreaView edges={['top']} style={[Layout.fill, styles.parentContainer]} >
        ...
        <ActionBar
            ...
            center={<Text style={styles.textHeaderTitle}>Create New Wallet</Text>}
        ...
        >
            <ScrollView
                ...
                <Text style={styles.textNote}>Write down or copy these words in the correct numbered order and keep them somewhere safe.</Text>

                <View style={[Layout.row, Layout.fullWidth]}>
                    <View style={[Layout.fill, Layout.alignItemsStart, {marginLeft: Responsive.width(24)}]}>
                        <View style={[Layout.rowHCenter, styles.viewInputContainer]}>
                            <Text style={styles.textInputNumber}>1. neglect</Text>
                        </View>
                        <View style={[Layout.rowHCenter, styles.viewInputContainer]}>
                            <Text style={styles.textInputNumber}>2. lazy</Text>
                        </View>
                        <View style={[Layout.rowHCenter, styles.viewInputContainer]}>
                            <Text style={styles.textInputNumber}>3. undo</Text>
                        </View>
                        <View style={[Layout.rowHCenter, styles.viewInputContainer]}>
                            <Text style={styles.textInputNumber}>4. bitter</Text>
                        </View>
                        <View style={[Layout.rowHCenter, styles.viewInputContainer]}>
                            <Text style={styles.textInputNumber}>5. dragon</Text>
                        </View>
                        <View style={[Layout.rowHCenter, styles.viewInputContainer]}>
                            <Text style={styles.textInputNumber}>6. shallow</Text>
                        </View>
                    </View>

                    <View style={[Layout.fill, Layout.alignItemsStart, {marginLeft: Responsive.width(24)}]}>
                        <View style={[Layout.rowHCenter, styles.viewInputContainer]}>
                            <Text style={styles.textInputNumber}>7. margin</Text>
                        </View>
                        <View style={[Layout.rowHCenter, styles.viewInputContainer]}>
                            <Text style={styles.textInputNumber}>8. copy</Text>
                        </View>
                        <View style={[Layout.rowHCenter, styles.viewInputContainer]}>
                            <Text style={styles.textInputNumber}>9. boil</Text>
                        </View>
                        <View style={[Layout.rowHCenter, styles.viewInputContainer]}>
                            <Text style={styles.textInputNumber}>10. panda</Text>
                        </View>
                        <View style={[Layout.rowHCenter, styles.viewInputContainer]}>
                            <Text style={styles.textInputNumber}>11. buyer</Text>
                        </View>
                        <View style={[Layout.rowHCenter, styles.viewInputContainer]}>
                            <Text style={styles.textInputNumber}>12. change</Text>
                        </View>
                    </View>
                </View>
            </ScrollView>
            ...
            >
                <Text style={styles.textButtonNext}>Continue</Text>
            </TouchableOpacity>
...
export default CreateNewWalletContainer
