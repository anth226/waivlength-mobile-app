...
const AdminChannelOverviewContainer = ({ }) => {
    ...
    const onOpenManageChannelAccessDialog = () => {
        EventBus.getInstance().fireEvent(EVENTS.OPEN_MANAGE_CHANNEL_ACCESS_DIALOG, {})
    };
    ...
    return (<SafeAreaView edges={['top']} style={[Layout.fill, styles.parentContainer]} >
        ...
        <View style={[Layout.rowCenter]}>
            <CustomImage height={Responsive.height(15)} width={Responsive.width(20)} source={Images.icChatRoomLock} style={{ paddingHorizontal: Responsive.width(15) }} />
            <Text style={styles.text44486FSemiBold14}>admin-only</Text>
        </View>
        ...
        <View style={[Layout.row, { paddingHorizontal: Responsive.width(20), marginTop: Responsive.height(10) }]}>
            <TouchableOpacity
                ...
                onPress={onOpenManageChannelAccessDialog}
            >
                <CustomImage height={Responsive.height(22)} width={Responsive.height(22)} source={Images.icInviteDrawerRight} />
                <Text style={styles.textButtonInvite}>Manage channel access</Text>
            </TouchableOpacity>
...
export default AdminChannelOverviewContainer
