    ...
    return (<SafeAreaView edges={['top']} style={[Layout.fill, styles.parentContainer]} >
        ...
        >
            <ScrollView
                ...
                <Text style={styles.textRecoveryPhrase}>Confirm Recovery Phrase</Text>
                <Text style={styles.textNote}>Tap each word in the correct order to fill the blanks</Text>

                <View style={[Layout.row, { marginBottom: Responsive.height(20)}]}>
                    <FlatList
                        nestedScrollEnabled={true}
                        contentContainerStyle={{ flexDirection: "row", flexWrap: "wrap", justifyContent: 'center' }}
                        data={DATA} renderItem={({ item }) =>
                            <TouchableOpacity style={styles.itemWordContainer}>
                                <Text style={styles.textWord}>{item.bio}</Text>
                            </TouchableOpacity>
                        }
                    />
                </View>
...
export default ConfirmWalletContainer
