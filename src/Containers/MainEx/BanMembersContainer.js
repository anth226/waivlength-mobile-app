...
const BanMembersContainer = ({ navigation }) => {
    ...
    return (<SafeAreaView edges={['top']} style={[Layout.fill, styles.parentContainer]} >
        ...
        <ActionBar
            ...
            center={<Text style={styles.textTitle}>Ban Member</Text>}
        />
        ...
        >
            <ScrollView
                ...
                <Text style={styles.textSubTitle}>Delete Message History</Text>
                <View style={[Layout.fullWidth]}>
                    <TouchableOpacity style={[Layout.fill, styles.viewActionWrapper]}>
                        <TouchableOpacity
                            style={{ height: Responsive.height(52), alignItems: 'center', flexDirection: 'row' }}>
                            <View style={{ width: Responsive.width(16) }} />
                            <Text style={[Layout.fill, styles.textHeader]}>Don’t delete any</Text>
                        ...
                        <TouchableOpacity
                            style={{ height: Responsive.height(52), alignItems: 'center', flexDirection: 'row' }}>
                            <View style={{ width: Responsive.width(16) }} />
                            <Text style={[Layout.fill, styles.textHeader]}>Previous 24 hours</Text>
                            <View style={{ width: Responsive.width(5) }} />
                            <RadioButton
                                selected={false}
                                size={22}
                        ...
                        <TouchableOpacity
                            style={{ height: Responsive.height(52), alignItems: 'center', flexDirection: 'row' }}>
                            <View style={{ width: Responsive.width(16) }} />
                            <Text style={[Layout.fill, styles.textHeader]}>Previous 7 days</Text>
                            <View style={{ width: Responsive.width(5) }} />
                            <RadioButton
                                selected={false}
                                size={22}
                ...
                <Text style={styles.textSubTitle}>Reason for ban</Text>
                <View style={Layout.fullWidth}>
                    <TextInput
                        onChangeText={text => { }}
                        editable={true}
        ...
        <View style={[Layout.fullWidth, Layout.rowCenter]}>
            <TouchableOpacity style={[styles.buttonWhiteWrapper, Layout.rowCenter]}>
                <Text style={styles.textWhiteButton}>Ban ‘Faruk’</Text>
            </TouchableOpacity>
        </View>
...
export default BanMembersContainer
