...
const ListOfActiveChallengeContainer = ({ }) => {
  ...
  return (<SafeAreaView edges={['top']} style={[Layout.fill, styles.parentContainer]} >
    ...
    <ActionBar
      ...
      center={<Text style={styles.textHeaderTitle}>Active Challenges</Text>}
      right={<View style={{ height: Responsive.width(36), width: Responsive.width(36) }} />}
    />
    <Text style={styles.textNote}>Active Challenges Refresh each Season</Text>
...
export default ListOfActiveChallengeContainer
