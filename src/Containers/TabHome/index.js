...
const TabHomeContainer = ({route}) => {
    ...
    return (<SafeAreaView style={[Layout.fill]} >
        ...
        <ActionBar
            ...
            right={<CustomImage source={Images.icSearch} width={Responsive.height(24)} height={Responsive.height(24)} style={{ alignItems: 'flex-end' }} onPress={() => {}}/>}
            center={<CustomImage source={Images.icWaivlength} width={Responsive.width(40)} height={Responsive.width(24)} />}
        />
